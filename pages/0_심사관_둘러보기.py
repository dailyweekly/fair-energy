...
st.markdown(
    ...
    <div style="background:#FFF7E5;border-radius:12px;padding:18px 22px;
        ...
        <div style="margin-top:10px;padding-top:10px;border-top:1px solid #F5E5C0;
            ...
            한전이 본인 명의로 직접 청구하는 가구(다세대 일반·아파트 등)는 본 솔루션 대상이 아닙니다.
            한전 메인 계량기 1개에 임대인이 받은 뒤 임차인에게 나눠서 청구하는 구조
            (고시원·다가구·반지하·일부 원룸형 다세대 등)가 본 솔루션 타깃입니다.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div style="background:white;border-radius:12px;padding:18px;
            ...
            <div style="font-size:13px;color:#4E5968;line-height:1.6;">
                고시원·다가구·일부 원룸은 한전 메인 계량기 1개로 임대인이 한꺼번에 전기료를 받고,
