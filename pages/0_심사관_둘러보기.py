...
st.markdown(
    ...
    <div style="background:#FFF7E5;border-radius:12px;padding:18px 22px;
        ...
        <div style="font-size:15px;color:#5D4037;line-height:1.7;">
            <b>임대인이 한전에서 한꺼번에 받아 임차인에게 분배 청구하는 전기요금</b>이
            <b>한전 공식 요금표대로 정확히 산정된 건지 임차인이 직접 확인할 수 없는 문제</b>를 풉니다.
        </div>
        <div style="margin-top:10px;padding-top:10px;border-top:1px solid #F5E5C0;
                    font-size:12px;color:#8D6E40;line-height:1.6;">
            <b>※ 타깃 정의 — 주거 형태가 아니라 청구 구조로 판단합니다.</b><br>
            <b>대상</b>: 한전 메인 계량기 1개에 임대인이 받은 뒤 임차인에게 나눠서 청구하는 구조.<br>
            <b>제외</b>: 한전이 본인 명의로 직접 청구하는 가구.<br>
            자주 발견되는 사례는 고시원·다가구 임차인이며, 다세대·반지하·원룸 등은 같은 건물·층이라도
            호실마다 청구 구조가 달라 일률적으로 포함·배제하지 않습니다.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div style="background:white;border-radius:12px;padding:18px;
            ...
            <div style="font-size:13px;color:#4E5968;line-height:1.6;">
                임대인이 한전 메인 계량기 1개로 한꺼번에 전기료를 받고, 세대별로 나눠 임차인에게 다시 청구합니다.
                고시원·다가구가 대표적이지만, 다세대·반지하·원룸 중에도 같은 구조가 존재합니다.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
