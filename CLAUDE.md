...
- 대상: 서울·수도권에서 **한전이 아닌 임대인이 매달 전기요금을 분배 청구**하는 구조의 임차인. **기준은 주거 형태가 아니라 청구 구조.** 자주 발견되는 사례는 고시원·다가구이며, 다세대·반지하·원룸 등은 호실마다 청구 구조가 달라 일률 포함·배제하지 않는다. 한전 명의로 본인이 직접 청구서를 받는 경우(본인 명의 한전 고객번호 보유)는 제외.
- 영역: **전기요금만**
- 채널: Streamlit 웹앱
- 데이터: SQLite
